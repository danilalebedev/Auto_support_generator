...
class SIGeneratorApp:
    ...
    def _build_ui(self) -> None:
        ...
        title = ttk.Label(outer, text="Supporting Information Generator", font=("Segoe UI", 16, "bold"))
        ...
        self.run_button = ttk.Button(actions, text="Generate SI", command=self._start_generation)
