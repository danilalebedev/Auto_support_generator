...
Если нужно добавить строку elemental analysis даже без found-значений в input,
включите в GUI `Advanced -> Calculate elemental analysis`. Тогда для каждого
соединения с формулой будет добавлена строка вида `Anal. Calcd for ...`.
Если found-значения есть, программа сохранит их и добавит часть `Found ...`.
...
Флаг `--calculate-elemental-analysis` включает генерацию расчетной строки
elemental analysis для всех соединений с формулой.
