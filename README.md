...
4. В `SI template .docx` можно выбрать Word-шаблон оформления. Это
   необязательно.
5. В `References .yml` можно выбрать файл со списком литературы. Это
   необязательно.
...
8. Оставьте `Check support` включенным, если хотите проверять ЯМР и HRMS.
