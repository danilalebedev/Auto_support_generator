...
GUI теперь организован как Fluent-style интерфейс с левой боковой панелью. Через пункты слева можно переключаться между генерацией, настройками обработки, проверкой, патчингом и добавлением соединений. Внизу боковой панели есть переключатель `Dark theme`: он включает светлую или темную тему, а выбранный режим сохраняется локально.
