...
class PackagingTests(unittest.TestCase):
    def test_collects_product_output_artifacts_when_paths_exist(self) -> None:
        ...
        self.assertEqual(artifacts["output_root"], str(output_root))
        self.assertEqual(manifest["output_paths"]["output_root"], str(output_root))
        ...
        self.assertEqual(manifest["relative_paths"]["output_root"], ".")
